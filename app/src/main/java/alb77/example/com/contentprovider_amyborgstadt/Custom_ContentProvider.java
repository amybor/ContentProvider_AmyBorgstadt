package alb77.example.com.contentprovider_amyborgstadt;
...
public class Custom_ContentProvider extends ContentProvider {
    static final String PROVIDER_NAME = "alb77.example.com.contentprovider_amyborgstadt.Custom_ContentProvider";// Provider
    // name
    ...
    static final String CREATE_DB_TABLE = " CREATE TABLE " + TABLE_NAME
            ...
            + " TEXT NOT NULL" + address + "TEXT NOT NULL" + birthday + "TEXT NOT NULL" + " );"; // Create table query
